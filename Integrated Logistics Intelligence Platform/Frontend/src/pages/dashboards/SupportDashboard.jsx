...
const customers = [
  {
    ...
    activity: "Shipment status viewed",
    time: "5 min ago",
  },
  {
    name: "Global Retail Ltd",
    shipment: "TRK-2026-102",
    activity: "ETA information checked",
    time: "18 min ago",
  },
  {
    name: "Metro Electronics",
    shipment: "TRK-2026-104",
    activity: "Delivery delay reviewed",
    time: "31 min ago",
  },
];
...
const alerts = [
  {
    ...
    description: "TRK-2026-104 has a delivery delay.",
    time: "12 min ago",
    type: "danger",
  },
  {
    title: "ETA updated",
    description: "TRK-2026-102 ETA has changed.",
    time: "28 min ago",
    type: "warning",
  },
  {
    title: "Delivery completed",
    description: "TRK-2026-098 was delivered successfully.",
    time: "42 min ago",
    type: "success",
  },
];
          ...
          <section className="support-bottom-grid">
            ...
            <div className="support-card exceptions-card">
              ...
              <div className="support-card-header">
                ...
                <div className="exception-count">09</div>
              </div>
