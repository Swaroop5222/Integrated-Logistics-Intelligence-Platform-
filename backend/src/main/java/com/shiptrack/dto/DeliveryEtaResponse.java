...
public class DeliveryEtaResponse {
    ...
    public double getRouteHours() {
        return routeHours;
    }

    public void setRouteHours(double routeHours) {
        this.routeHours = routeHours;
    }

    public double getTrafficDelayHours() {
        return trafficDelayHours;
    }

    public void setTrafficDelayHours(double trafficDelayHours) {
        this.trafficDelayHours = trafficDelayHours;
    }
    ...
    public double getPredictedDelayHours() {
        return predictedDelayHours;
    }

    public void setPredictedDelayHours(double predictedDelayHours) {
